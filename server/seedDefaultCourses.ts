...
export const getSPCModules = (courseId: string): Omit<InsertModule, 'id'>[] => [
  {
    ...
    duration: '60 mins',
    order: 1,
    videoUrl: 'https://www.youtube.com/embed/NzCrrB17_04',
    completed: false,
    hasQuiz: true,
  ...
  },
  {
    ...
    duration: '90 mins',
    order: 2,
    videoUrl: 'https://www.youtube.com/embed/olMgPCxdzJ8',
    completed: false,
    hasQuiz: true,
  ...
  },
  {
    ...
    duration: '75 mins',
    order: 3,
    videoUrl: 'https://www.youtube.com/embed/VWJl_Ab3zy8',
    completed: false,
    hasQuiz: true,
  ...
  },
  {
    ...
    duration: '90 mins',
    order: 4,
    videoUrl: 'https://www.youtube.com/embed/5wjrU5RwoaA',
    completed: false,
    hasQuiz: true,
  ...
  },
  {
    ...
    duration: '120 mins',
    order: 5,
    videoUrl: 'https://www.youtube.com/embed/aSA57lXgwg0',
    completed: false,
    hasQuiz: true,
...
export const getCpCpkModules = (courseId: string): Omit<InsertModule, 'id'>[] => [
  {
    ...
    duration: '45 mins',
    order: 1,
    videoUrl: 'https://www.youtube.com/embed/BsxJfRx9o5Y',
    completed: false,
    hasQuiz: true,
  ...
  },
  {
    ...
    duration: '60 mins',
    order: 2,
    videoUrl: 'https://www.youtube.com/embed/4Y5T7grGYMU',
    completed: false,
    hasQuiz: true,
  ...
  },
  {
    ...
    duration: '90 mins',
    order: 3,
    videoUrl: 'https://www.youtube.com/embed/GEn8-iEB-ao',
    completed: false,
    hasQuiz: true,
  ...
  },
  {
    ...
    duration: '75 mins',
    order: 4,
    videoUrl: 'https://www.youtube.com/embed/xfQ5_fUgQmI',
    completed: false,
    hasQuiz: true,
  ...
  },
  {
    ...
    duration: '60 mins',
    order: 5,
    videoUrl: 'https://www.youtube.com/embed/mZJTzdSl3UY',
    completed: false,
    hasQuiz: true,
